...
{
    static public class ProvisionExtranet
    {
        ...
        static  public void AddLibrariesToSite(this Web web, string libraryList)
        {
        ...
        static public void CreateSiteAndLibraries(this Web web, string siteName, string libraryList)
        {
